        ...
        public async Task<IActionResult> Update(Product product)
        {
            ...
            catch (DbUpdateConcurrencyException exception)
            {
               ...
               var clientValues = exceptionEntry.CurrentValues;
                ...
                {
                    ModelState.AddModelError(string.Empty, "bu ürün başka kullanıcı tarafından silindi");
                }
                else
                {
                    var databaseProduct = databaseValues.ToObject() as Product;
                    ModelState.AddModelError(string.Empty, "bu ürün başka kullanıcı tarafından güncellendi");
                }
                return View(product);
            }
